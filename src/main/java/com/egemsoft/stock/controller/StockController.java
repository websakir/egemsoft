...
public class StockController {
    ...
    @GetMapping("/")
    public List<Company> getCompanyList(@RequestHeader Map<String, String> header,
        ...
        loggerService.saveVisitor(new Logger(new Date(), header.toString(), ""));
    ...
    @GetMapping("/artisazalis")
    public Map<String, List<StockDetail>> getDiagram() {
        return stockDetailService.getStockDetailGraph();
    }
}
